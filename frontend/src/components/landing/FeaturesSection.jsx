...
const features = [
  {
    number: "01",
    title: "Instant Isolated Runtime",
    description: "Spin up a full-featured sandbox container inside our Kubernetes cluster in seconds. No local setups or heavy dependencies required.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Gemini-Powered Workspace",
    description: "Describe edits, bug fixes, or enhancements. The AI Orchestrator streams modifications in real-time, executing changes safely.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Live Previews & Hot Reloads",
    description: "Inspect output dynamically with a live-loaded iframe. Changes are hot-reloaded automatically through our custom proxy routes.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Secure Sandbox Boundaries",
    description: "Your code is shielded by strict RBAC policies, network restrictions, and separate containers. Secure environments for modern teams.",
    visual: "security",
  },
];
