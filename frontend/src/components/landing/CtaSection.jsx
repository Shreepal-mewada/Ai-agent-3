...
export function CtaSection({ user, onLogin, onStartCreating }) {
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  <a
                    href="#how-it-works"
                    className="inline-flex items-center justify-center h-14 px-8 text-base rounded-full border border-foreground/20 hover:bg-foreground/5 transition-all"
                  >
                    See how it works
                  </a>
                </div>
